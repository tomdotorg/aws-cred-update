Purpose: do not rely on this for real use. It is intended to perform multi-factor authentication to aws and write the resulting token to a credentials file.
